...
"""Implementation of structured outputs using OpenAI models."""
...
def create_response_parser(
    response_format: type[InnerMonologue],
    patched_response_format: type[BaseModel],
) -> Callable[[str, ContextVariables], InnerMonologue]:
...
def create_strategy(model: str) -> Strategy[InnerMonologue]:
    """Create an OpenAI strategy using Pydantic schema validation."""
